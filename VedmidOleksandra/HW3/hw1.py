...
# print/сounting occurrences of specific words
print('Number of occurrence of better:', pythons_philosophy.count("better"))
print('Number of occurrence of never:', pythons_philosophy.count("never"))
print('Number of occurrence of is:', pythons_philosophy.count("is"))
print()

# convert pythons_philosophy to uppercase
print(pythons_philosophy.upper())
print()

# replace all occurrences of the symbol "i" with "&"
replaced_text = pythons_philosophy.replace("i", "&")
print(replaced_text)
