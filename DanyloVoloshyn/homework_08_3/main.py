from calculator import rectangle_area, triangle_area, circle_area


while True:
    choose_function = input(
        "Hello, please select the function you need(rectangle, triangle, circle) or type 'exit' to quit: ")
